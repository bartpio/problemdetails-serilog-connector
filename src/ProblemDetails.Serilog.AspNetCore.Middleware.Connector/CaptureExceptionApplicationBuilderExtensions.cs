...
namespace Serilog.AspNetCore
{
    ...
    /// </summary>
    public static class CaptureExceptionApplicationBuilderExtensions
    {
        /// <summary>
        /// Adds middleware that captures exceptions into the <see cref="IDiagnosticContext"/>.
        /// </summary>
        ...
        public static IApplicationBuilder UseSerilogRequestLoggingCaptureException(this IApplicationBuilder app)
        {
            app.UseMiddleware<RequestLoggingCaptureExceptionMiddleware>();
            return app;
        }
    }
}
